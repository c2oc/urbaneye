...
module.exports = {
  ...
  // reminder for prod deployment -> https://tailwindcss.com/docs/optimizing-for-production
  presets: [],
  ...
  theme: {
    ...
    colors: {
      ...
      subtitleGray: colors.subtitleGray,
    ...
    boxShadow: {
      ...
      wildcard: '0px 4px 4px rgba(40, 40, 40, 0.25)',
      none: 'none',
    },
    container: {},
    cursor: {
